...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240320141107_Version06")]
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 20, 11, 11, 7, 247, DateTimeKind.Local).AddTicks(7984),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 20, 11, 11, 7, 261, DateTimeKind.Local).AddTicks(3180),
