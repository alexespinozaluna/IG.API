...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240319201235_Version02")]
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 19, 17, 12, 34, 950, DateTimeKind.Local).AddTicks(2924),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 19, 17, 12, 34, 961, DateTimeKind.Local).AddTicks(3218),
