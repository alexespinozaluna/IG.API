...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240319200944_Version01")]
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 19, 17, 9, 44, 825, DateTimeKind.Local).AddTicks(2958),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 19, 17, 9, 44, 836, DateTimeKind.Local).AddTicks(2892),
