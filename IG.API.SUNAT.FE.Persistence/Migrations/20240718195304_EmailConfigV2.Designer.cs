...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240718195304_EmailConfigV2")]
    partial class EmailConfigV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 7, 18, 15, 53, 3, 823, DateTimeKind.Local).AddTicks(6678),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 7, 18, 15, 53, 3, 880, DateTimeKind.Local).AddTicks(2698),
