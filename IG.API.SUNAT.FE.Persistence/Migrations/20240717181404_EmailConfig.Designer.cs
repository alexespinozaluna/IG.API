...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240717181404_EmailConfig")]
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 7, 17, 14, 14, 4, 199, DateTimeKind.Local).AddTicks(1895),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 7, 17, 14, 14, 4, 234, DateTimeKind.Local).AddTicks(1722),
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.EmailConfig", b =>
                {
                    b.HasOne("IG.API.SUNAT.FE.Entity.maeEmpresa", "Empresa")
                        .WithOne("Email")
                        .HasForeignKey("IG.API.SUNAT.FE.Entity.EmailConfig", "IdEmpresa")
