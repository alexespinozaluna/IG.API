...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240325172452_PROC_spGetApiEndPointInfo")]
    partial class PROC_spGetApiEndPointInfo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 25, 14, 24, 52, 16, DateTimeKind.Local).AddTicks(8186),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 25, 14, 24, 52, 37, DateTimeKind.Local).AddTicks(5224),
