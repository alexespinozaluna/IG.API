...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240619233927_Empresa_IdmaeEmpresa_a_IdEmpresa")]
    partial class Empresa_IdmaeEmpresa_a_IdEmpresa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 6, 19, 19, 39, 27, 588, DateTimeKind.Local).AddTicks(2139),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 6, 19, 19, 39, 27, 612, DateTimeKind.Local).AddTicks(9670),
