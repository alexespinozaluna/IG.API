...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240325155901_Version10")]
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 25, 12, 59, 1, 580, DateTimeKind.Local).AddTicks(3792),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 25, 12, 59, 1, 609, DateTimeKind.Local).AddTicks(9507),
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.OauthAccessToken", b =>
                {
                    b.HasOne("IG.API.SUNAT.FE.Entity.maeEmpresa", "Empresa")
                        .WithOne("Token")
                        .HasForeignKey("IG.API.SUNAT.FE.Entity.OauthAccessToken", "IdEmpresa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
