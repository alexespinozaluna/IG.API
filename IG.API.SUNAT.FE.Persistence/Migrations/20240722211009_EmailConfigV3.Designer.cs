...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240722211009_EmailConfigV3")]
    partial class EmailConfigV3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 7, 22, 17, 10, 9, 223, DateTimeKind.Local).AddTicks(5692),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 7, 22, 17, 10, 9, 250, DateTimeKind.Local).AddTicks(9258),
