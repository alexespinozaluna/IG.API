...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240614140442_Empresa_SistemaUsuario_V2")]
    partial class Empresa_SistemaUsuario_V2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 6, 14, 10, 4, 41, 874, DateTimeKind.Local).AddTicks(266),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 6, 14, 10, 4, 41, 897, DateTimeKind.Local).AddTicks(438),
