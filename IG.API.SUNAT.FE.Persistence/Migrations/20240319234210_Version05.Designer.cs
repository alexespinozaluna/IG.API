...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240319234210_Version05")]
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 19, 20, 42, 10, 546, DateTimeKind.Local).AddTicks(4900),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 19, 20, 42, 10, 559, DateTimeKind.Local).AddTicks(8671),
