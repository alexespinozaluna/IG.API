...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240611234113_Empresa_SistemaUsuario_v1")]
    partial class Empresa_SistemaUsuario_v1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 6, 11, 19, 41, 13, 595, DateTimeKind.Local).AddTicks(6930),
                            Method = "GET"
                        },
                        new
                        {
                        ...
                        {
                            Id = 6,
                            ApiURL = "https://api-cpe.sunat.gob.pe/v1/contribuyente/gem/comprobantes/",
                            BodyRequest = "",
                        ...
                        {
                            Id = 7,
                            ApiURL = "https://api-cpe.sunat.gob.pe/v1/contribuyente/gem/comprobantes/envios/",
                            BodyRequest = "",
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 6, 11, 19, 41, 13, 624, DateTimeKind.Local).AddTicks(6936),
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SistemaUsuario", b =>
                {
                    b.HasOne("IG.API.SUNAT.FE.Entity.maeEmpresa", "Empresa")
                        .WithOne("Usuario")
                        .HasForeignKey("IG.API.SUNAT.FE.Entity.SistemaUsuario", "IdmaeEmpresa")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
