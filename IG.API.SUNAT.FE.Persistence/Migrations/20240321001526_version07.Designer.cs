...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240321001526_version07")]
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 20, 21, 15, 26, 656, DateTimeKind.Local).AddTicks(1073),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 20, 21, 15, 26, 667, DateTimeKind.Local).AddTicks(5110),
