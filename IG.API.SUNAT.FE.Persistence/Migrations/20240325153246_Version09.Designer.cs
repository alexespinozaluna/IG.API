...
namespace IG.API.SUNAT.FE.Persistence.Migrations
{
    ...
    [Migration("20240325153246_Version09")]
    partial class Version09
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.APIEndPoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 25, 12, 32, 46, 280, DateTimeKind.Local).AddTicks(560),
                            Method = "GET"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.OauthAccessToken", b =>
                {
                    ...
                    b.Property<int>("EmpresaIdmaeEmpresa")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmpresaIdmaeEmpresa");
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.SUNATFEXMLEspacioNombreTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 3, 25, 12, 32, 46, 331, DateTimeKind.Local).AddTicks(8985),
            ...
            modelBuilder.Entity("IG.API.SUNAT.FE.Entity.OauthAccessToken", b =>
                {
                    b.HasOne("IG.API.SUNAT.FE.Entity.maeEmpresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("EmpresaIdmaeEmpresa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
