...
namespace IG.API.SUNAT.FE.Services
{
    public class EmailConfigService:IEmailConfigService
    {
        ...
        public EmailConfigService(IEmailConfigRepo repo, ILogger<EmailConfigService> logger, IMapper mapper)
        {
            _repo = repo;
            _logger = logger;
            _mapper = mapper;
        ...
        public async Task<BaseResponseGeneric<int>> AddAsync(EmailConfig request)
        {
        ...
        public async Task<BaseResponseGeneric<EmailConfig>> FindByIdAsync(int id)
        {
            var response = new BaseResponseGeneric<EmailConfig>();
        ...
        public async Task<BaseResponseGeneric<ICollection<EmailConfig>>> ListAsync()
        {
            var response = new BaseResponseGeneric<ICollection<EmailConfig>>();
        ...
        public async Task<BaseResponse> UpdateAsync(int Id, EmailConfig request)
        {
            var response = new BaseResponse();
            try
            {
